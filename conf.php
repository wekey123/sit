...
if(!empty($_POST['submit'])){
	...
	@extract($_POST);
	$sess_id = $_SESSION['id'];
	$sql = "INSERT INTO conf (staff_id,tit,aname,caname,confname,clgname,pubdate) VALUES ($sess_id,'$tit','$aname','$caname','$confname','$clgname','$pubdate')";
	...
	header('location:confviewstaff.php?errorjou='.$flag );
}else{
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>SIT | CONFERENCE FORM</title>
...
<div class="main">
    ...
    <div class="content">
        ...
        <div class="mainbar">
          ...
          <tr><td><br/><br/></td></tr>
          <tr>
            <td colspan="2" style="text-align:center";><strong><span class="style5"><i>CONFERENCE</i></span></strong></td>
          </tr>
           <tr><td><br/></td></tr>
          <tr>
          ...
          <tr>
            <td width="319" height="49" bgcolor="#000000" style="text-align:center";><span class="style15">CONFERENCE NAME</span></td>
            <td width="307"><span class="style15"><input type="text" name="confname" /></span></td>
          </tr>
          
          
          <tr>
            <td width="319" height="49" bgcolor="#000000" style="text-align:center";><span class="style15">COLLEGE NAME</span></td>
            <td width="307"><span class="style15"><input type="text" name="clgname" /></span></td>
          </tr>
