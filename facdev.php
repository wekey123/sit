...
<div class="main">
  <div class="header">
    <div class="header_resize">
	  ...
	  <ul>
          ...
          <li class="active"><a href="support.php">Staffs</a></li>
          <li><a href="apply.php">faculty participent </a></li>
		    <li > <a h href= > faculty developement </a></li>
  ...
  <div class="content">
    <div class="content_resize">
      ...
      <div class="mainbar">
        <table width="659" height="275" border="1">
          <tr>
            <td colspan="2"><span class="style3">
              <label>              </label>
            </span>
              <label><div align="center" class="style4"><em><strong>CHOOSE YOUR OPTION</strong></em></div>
            </label>
              <div align="center" class="style4"><strong>&nbsp; </strong></div></td>
            </tr>
          <tr>
            <td width="365" rowspan="2"><img src="images/download (2).jpg" width="365" height="271" /></td>
            <td width="278">&nbsp; </td>
          </tr>
          <tr>
            <td>&nbsp;</td>
